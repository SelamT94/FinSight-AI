"""Mistral track via Ollama or OpenAI-compatible API (vLLM)."""
...
class MistralModel:
    """Same summary API as ``LlamaModel`` plus comparative / judge prompts on the Mistral endpoint."""
